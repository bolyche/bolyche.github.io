...
Sometimes I see things like duplicted code or lack of variables or just more often, extremely big long-running dependency graphs being built on running `terraform plan` and I wonder, why haven't these people read page 1 of the terraform docs?
